...
public class Nota implements Serializable {
     ...
     * Invariante : la data deve essesere inferiore o uguale alla data corrente
     **/
    @Column(nullable = false)
     ...
     **/
    public Nota(String contenuto, GregorianCalendar dataPubblicazione, Autore autore, Medico medico, Paziente paziente) {
