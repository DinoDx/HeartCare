...
function addClassActive(id, nomeClasseMainContent) {
    ...
    if(window.innerWidth < 768){
        ...
        if(document.getElementsByClassName(nomeClasseMainContent)[0]!= undefined && document.getElementsByClassName(nomeClasseMainContent)[0].style.display != "flex")
            document.getElementsByClassName(nomeClasseMainContent)[0].style.display ="flex";
    }
}
