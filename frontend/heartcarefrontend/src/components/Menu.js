  ...
  return (
    <div className="contenitoreMenu">
      ...
      <div className="contenitoreVociMenu">
        ...
        <Link to={"/Home"}  className="voceMenuText" onClick={() => addClassActive(1)}>
        ...
        <Link to={"/Schedule"}  className="voceMenuText" onClick={() => addClassActive(2)}>
        ...
        <Link to={"/Pazienti"}  className="voceMenuText"  onClick={() => addClassActive(3)}>
        ...
        <Link to={"/Profilo"}  className="voceMenuText"  onClick={() => addClassActive(4)}>
        ...
        <Link to={"/About"}  className="voceMenuText"  onClick={() => addClassActive(5)}>
